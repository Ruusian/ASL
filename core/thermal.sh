...
asl_thermal_report() {
    ...
    thermal_headroom=$( (timeout 1 dumpsys hardware_properties 2>/dev/null || timeout 1 asl_exec "dumpsys hardware_properties" 2>/dev/null) | awk -F= '/ThermalHeadroom/ {print $2}' )
